...
export const authMiddleware = async (
  ...
  try {
    const apiKey = req.headers[DEFAULT_CONFIG.apiKeyHeader.toLowerCase()] as string;
    ...
    // Log API usage
    console.log(`API Request: ${req.method} ${req.path} - User: ${validationResult.userId} - IP: ${req.ip}`);
